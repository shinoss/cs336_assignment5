...
def run_get_response_log_probs(
    ...
    """
    return get_response_logprobs(model, input_ids, labels, return_token_entropy)
...
def run_grpo_train_step(
    ...
    return grpo_train_step(
        ...
        repeated_ground_truths, group_size, baseline, advantage_eps,
        advantage_normalizer, importance_reweighting_method, 
